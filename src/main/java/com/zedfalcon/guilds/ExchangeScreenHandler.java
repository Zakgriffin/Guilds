...
public class ExchangeScreenHandler extends AbstractRecipeScreenHandler<RecipeInputInventory> {
    ...
    public ExchangeScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
